    ...
    <>
      <section className="main">
        <div className="container">
          <h3 className="main__title" data-aos="fade-down">
            Most visited destinations
          </h3>
          <div className="main__content grid">
            {data.map((item) => (
              <div className="main__item" key={item.id} data-aos="fade-up">
                <figure className="main__img">
                  <img src={item.imgSrc} alt={item.destTitle} />
                </figure>

                <div className="main__info">
                  <h5 className="main__item--title">{item.destTitle}</h5>
                  <div className="main__location flex">
                    <IoLocationOutline className="icon" />
                    <span>{item.location}</span>
                  </div>

                  <div className="main__fees flex">
                    <div className="grade">
                      <span>
                        {item.grade}
                        <small>+1</small>
                    ...
                    <h6 className="price">${item.fees}</h6>
                  </div>

                  <p className="main__descr">{item.description}</p>
